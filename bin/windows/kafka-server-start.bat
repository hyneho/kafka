...
IF EXIST "%~dp0../../config/log4j.properties" (
    ...
    echo You can also use the %~dp0../../config/log4j2.yml file as a starting point. Make sure to remove the Log4j 1.x configuration after completing the migration.
    set KAFKA_LOG4J_OPTS=-Dlog4j.configuration=file:%~dp0../../config/log4j.properties
) ELSE IF EXIST "%~dp0../../config/log4j2.yml" (
    set KAFKA_LOG4J_OPTS=-Dlog4j2.configurationFile=%~dp0../../config/log4j2.yml
