...
class FetchFromFollowerTest(ProduceConsumeValidateTest):
    ...
    def test_consumer_preferred_read_replica(self, metadata_quorum=quorum.isolated_kraft, use_new_coordinator=False, group_protocol=consumer_group.classic_group_protocol):
        """
