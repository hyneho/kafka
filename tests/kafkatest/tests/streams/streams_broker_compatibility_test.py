...
class StreamsBrokerCompatibility(Test):
    ...
    - Streams works for older brokers 3.0 (or newer)
    - Streams w/ EOS-alpha works for older brokers 3.0 (or newer)
    - Streams w/ EOS-v2 works for older brokers 3.0 (or newer)
    """
    ...
    @cluster(num_nodes=4)
    @matrix(broker_version=[str(LATEST_3_0), str(LATEST_3_1),str(LATEST_3_2),str(LATEST_3_3),str(LATEST_3_4),
