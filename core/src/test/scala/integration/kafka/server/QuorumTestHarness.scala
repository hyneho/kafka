...
object QuorumTestHarness {
  ...
  def getTestQuorumAndGroupProtocolParametersClassicGroupProtocolOnly_KAFKA_18095: stream.Stream[Arguments] = getTestQuorumAndGroupProtocolParametersClassicGroupProtocolOnly
}
