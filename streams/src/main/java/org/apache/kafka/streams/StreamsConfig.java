...
public class StreamsConfig extends AbstractConfig {
    ...
    public static final String PROCESSOR_WRAPPER_CLASS_DOC = "A processor wrapper class that implements the <code>org.apache.kafka.streams.state.ProcessorWrapper</code> interface. "
